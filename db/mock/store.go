...
// Source: bank-service/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (db.GetEntryRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntry", arg0, arg1)
	ret0, _ := ret[0].(db.GetEntryRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (db.GetTransferRow, error) {
	m.ctrl.T.Helper()
